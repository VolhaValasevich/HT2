...
<body>
	...
	<table align="center" border="1" width="90%">
		...
		<tr>
			<td colspan="6" align="center"><a
				href="<%=request.getContextPath()%>/?action=addPerson">Добавить
					запись</a></td>
		</tr>
		<tr>
 ...
 %>
			...
			<td><a
				href="<%=request.getContextPath()%>/?action=editPerson&amp;id=<%=person.getId()%>">Редактировать</a></td>
			<td><a
				href="<%=request.getContextPath()%>/?action=deletePerson&amp;id=<%=person.getId()%>">Удалить</a></td>
		</tr>
		<%
			}
		%>
